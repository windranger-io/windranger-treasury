...
> Access control using a predefined set of roles.

The roles and their relationship to each other are defined.

*There are two categories of role: - Global; permissions granted across all DAOs. - Dao; permissions granted only in a single DAO.*
