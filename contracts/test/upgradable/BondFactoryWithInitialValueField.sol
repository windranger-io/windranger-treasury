...
/**
 * Contract matching the data layout of the BondFactory, but with a field initialised on construction.
 */
contract BondFactoryWithInitialValueField is
    CollateralWhitelist,
    OwnableUpgradeable,
    UUPSUpgradeable
{
    address private _treasury;
    uint256 private _initiallyPopulated = 77;
